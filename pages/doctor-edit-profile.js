...
const EditProfile = () =>{
    ...
    useEffect(() => {
      ...
      }, [currentUser, idImageUrl, isPersonId, doctorData, personImageUrl, dispatch]);
    ...
    return Object.keys(doctorData).length === 0 ? <div style={{height:"100vh",margin:"25px"}} > <img src="/spinner.gif" width={"100dvw"} height={"100dvh"} alt="" /> </div> : <IntlProvider locale={language} messages={message[language]} >
    {doctorData.verified ? <div style={{height:"100dvh"}} ><h1 className={classes.heading} > <FormattedMessage id="doctor_id_confirmed_message" defaultMessage="default" values={{language}} /> </h1> </div>
    :
    <>
    <div style={{height:"100vh"}} >
      <h1 className={classes.heading}> <FormattedMessage id="heading" defaultMessage="default" values={{language}} /> </h1>
    <p className={classes.profile_explanation} > <FormattedMessage id="doctor_edit_profile_explanation" defaultMessage="default" values={{language}} /> </p>
